...
class basic_lzma_encoder : public compression_encoder_interface_basic<ELEM_TYPE, TRAITS_TYPE>
{
public:
    ...
    bool is_init() const override { return _ostream.is_init(); }

    size_t get_bytes_read() const override { return _istream.get_bytes_read(); }

    size_t get_bytes_written() const override { return _ostream.get_bytes_written(); }

    ELEM_TYPE* get_buffer_begin() override { return _istream.get_buffer_begin(); }

    ELEM_TYPE* get_buffer_end() override { return _istream.get_buffer_end(); }

    void encode_next(size_t length) override { _istream.compress(length); }
